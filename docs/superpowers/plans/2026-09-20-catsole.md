...
**Spec:** `docs/superpowers/specs/2026-09-20-catsole-design.md`
...
**Files:**
- Create: `.gitignore`, `server/requirements.txt`, `server/pytest.ini`, `server/catsole/__init__.py`
...
**Files:**
- Create: `server/catsole/protocol.py`
...
**Files:**
- Create: `server/catsole/lyrics.py`
...
**Files:**
- Create: `server/catsole/media.py`
...
**Files:**
- Create: `server/catsole/hardware.py`
...
**Files:**
- Create: `server/catsole/app.py`, `server/run.py`, `server/catsole/config.py`
...
**Files:**
- Create: `server/catsole/web.py`, `server/catsole/static/panel.html`
...
**Files:**
- Create: `arduino/catsole/catsole.ino`
...
- [ ] **Step 3:** Compile: `arduino-cli compile --fqbn arduino:renesas_uno:unor4wifi arduino/catsole`. Expected: success, with flash/RAM usage reported.
...
- [ ] **Step 2:** Add rotating file logging to `%LOCALAPPDATA%\catsole\` in `run.py`, since `pythonw` has no console.
...
- [ ] **Step 3:** `gh repo create teterw/catsole --public --source . --remote origin --push`.
